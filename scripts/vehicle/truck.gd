...
## Толщина борта. Восьми пикселей не хватало: осколок, зашедший в доску
## глубоко, солвер выталкивал в ближайшую сторону, а ближайшей нередко
## оказывалась наружная.
const BED_WALL_THICKNESS: float = 12.0
