...
## Из чего вещь сделана — с точки зрения слуха, а не физики. Подставляется
## в ключ звука разбития: "glass" даёт break_glass, "clay" — break_clay.
## Отдельно от physics_material сознательно: трение и отскок описывают
## поверхность, а звенит вещь по своему материалу — у стеклянного флакона
## и глиняной амфоры трение может совпасть, а звук разбития не совпадёт
## никогда.
## Заведённые материалы: "wood", "clay", "glass".
@export var sound_material: StringName = &"clay"
